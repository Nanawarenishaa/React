...
function App() {
  const [data, setData] = useState([
    ...
    },
    {
      ...
      description:
        "Red Dead Redemption 2 is an epic tale of life in America’s unforgiving heartland. The game's vast and atmospheric world provides the foundation for a brand new online multiplayer experience.",
    ...
    },
    {
      ...
      description:
        "Assassin's Creed Valhalla is an action role-playing game set in the Viking Age. Become Eivor, a legendary Viking raider on a quest for glory.",
    ...
    },
    {
      ...
      description:
        "Call of Duty: Warzone is a free-to-play battle royale game. Drop into a massive combat arena, loot, and fight to be the last squad standing.",
    ...
    },
    {
      ...
      name: "Fortnite",
      description:
        "Fortnite is a popular battle royale game where players can build structures and compete in intense PvP battles.",
    ...
    },
    {
      ...
      name: "Apex Legends",
      description:
        "Apex Legends is a free-to-play battle royale game set in the Titanfall universe. Choose your legend, team up, and battle for fame and fortune.",
    ...
    },
    {
      ...
      description:
        "The Elder Scrolls V: Skyrim is an open-world action RPG known for its vast, immersive world and rich storytelling.",
    ...
    <>
          ...
          <div className="container min-h-96 grid grid-cols-1 lg:grid-cols-2 gap-16 bg-slate-900 rounded-lg p-8 w-[80%] shadow-lg  ">
            <div className="p-4">
              ...
              <p className=" text-xl text-slate-200 mt-6">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Doloremque ab tempore aspernatur animi doloribus? Dignissimos
                magnam voluptatem nulla quos laborum.
              </p>
      ...
      <section className="w-full min-h-screen bg-slate-300 flex flex-col items-center justify-center">
        <input
          type="text"
          placeholder="Search..."
          className="p-2 pr-24 rounded-lg bg-slate-900 text-white font-bold"
          value={searchTerm}
          onChange={Search}
        />
        <button
          type="button"
          onClick={addCard}
          className="bg-black text-white py-2 px-4 rounded-lg font-bold mt-4"
        >
          Add Game Card
        </button>
